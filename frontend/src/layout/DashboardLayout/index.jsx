  ...
  return (
    <div>
       <div className="Container">
        <div className={styles.homeContainer}>
            <div className={styles.homeContainer_leftBar}>
                  <div onClick={()=>{router.push("/dashboard")}} className={styles.sidebaroptions}>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6"></svg>
                </div>
        ...
        <div className="homeContainer_extraContanier">
              <h1>Top Profiles</h1>
              
             {authState.all_profiles_fetched && authState.all_users.map((profile,index)=>{
              return (
                <div key={profile.id} className={styles.extra_Container_profile}>
